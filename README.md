...
> **Note:** you can skip this step if you already have an existing Azure DevOps organization that you want to use.
...
> **Note:** you can skip this step if you already have an existing Azure DevOps project that you want to use.
...
> **Note:** you can skip this step if you already have an existing Azure Storage account that you want to use.
...
> **Note:** you can skip this step if you already have an existing Azure Storage container that you want to use.
...
> **Note:** you can skip this step if you already have an existing Azure DevOps git repository that you want to use.
